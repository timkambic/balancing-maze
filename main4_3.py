...
_, img_src = cap.read()
path_list, img_maze_solved = mazeAnalysisAndStuff(img_src,8,8) # find path through maze; returns: list of path tiles, image with data
...
_, img_src = cap.read()
STEP_X,STEP_Y = calculateSTEP(img_src,MAZE_SIZE_X,MAZE_SIZE_Y)
